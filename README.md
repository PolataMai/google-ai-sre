...
| [aisre/](aisre/) | AI SRE MVP(12 周计划第 1–2 周交付):场景定义、事件/动作 Schema、服务目录、90 天基线 | 64 |
...
- [ ] 第 3–4 周:告警接入、五类只读连接器、证据存储
- [ ] 第 5–6 周:告警丰富、Top-3 假设、事故工作台、120 秒链路
- [ ] 第 7–8 周:Gold 数据、时间切片回放、指标看板、Shadow
